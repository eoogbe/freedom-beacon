...
exports.route = function(app) {
    ...
    app.get('/friends', Facebook.loginRequired(app.locals.fb), friends.index);
    app.get('/friends/search', Facebook.loginRequired(app.locals.fb), friends.search);
    app.get('/friends/create', Facebook.loginRequired(app.locals.fb), friends.create);
